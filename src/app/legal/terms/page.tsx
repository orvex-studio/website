                ...
                <div className="bg-linear-to-br from-zinc-950/80 to-zinc-900/80 backdrop-blur-xl border border-white/10 rounded-3xl p-8 sm:p-12 shadow-2xl">
                    <div className="space-y-12">
                        <section className="group">
                            <div className="bg-white/5 rounded-xl p-6 border border-white/5">
                                <p className="text-gray-300 leading-relaxed text-lg">
                                    ...
                                    govern your use of Orvex Services&apos;
                                    (&quot;Orvex,&quot; &quot;we,&quot;
                                    &quot;our,&quot; or &quot;us&quot;)
                                    services, including our products, platforms,
                                    and ventures, including but not limited to
                                    web development, mobile app development,
                                    enterprise software solutions, cloud
                                    services, consulting, and related services
                                    (collectively, &quot;Services&quot;). By
                                    engaging with Orvex Services or using our
                        ...
                        <section className="group">
                            ...
                            <div className="bg-white/5 rounded-xl p-6 border border-white/5">
                                <p className="text-gray-300 leading-relaxed">
                                    ...
                                    Terms, you may not use our Services. These
                                    Terms apply to all clients, users, and
                                    visitors of Orvex Studios.
                                </p>
                            </div>
                        </section>
                        ...
                        <section className="group">
                            ...
                            <div className="bg-white/5 rounded-xl p-6 border border-white/5">
                                <p className="text-gray-300 leading-relaxed mb-4">
                                    Orvex Studios provides custom software
                                ...
                                <ul className="space-y-3 text-gray-300">
                                    ...
                                    <li className="flex items-start">
                                        <div className="w-2 h-2 bg-green-400 rounded-full mt-2 mr-3 shrink-0"></div>
                                        <span>
                                            Cloud solutions and serverless
                                            architectures
                                        </span>
                                    </li>
                                    <li className="flex items-start">
                                    ...
                                    <li className="flex items-start">
                                        <div className="w-2 h-2 bg-green-400 rounded-full mt-2 mr-3 shrink-0"></div>
                                        <span>
                                            Technical consulting and software
                                            architecture services
                                        </span>
                                    </li>
                                </ul>
                                <p className="text-gray-300 leading-relaxed mt-4">
                                    Specific services, deliverables, timelines,
                                    and pricing are defined in individual
                                    project agreements, statements of work
                            ...
                            <div className="bg-white/5 rounded-xl p-6 border border-white/5">
                                ...
                                <ul className="space-y-3 text-gray-300">
                                    <li className="flex items-start">
                                        ...
                                        <span>
                                            You will provide accurate, complete,
                                    ...
                                    <li className="flex items-start">
                                        <div className="w-2 h-2 bg-purple-400 rounded-full mt-2 mr-3 shrink-0"></div>
                                        <span>
                                            You will not use our Services for
                                    ...
                                    <li className="flex items-start">
                                        ...
                                        <span>
                                            ...
                                            laws, regulations, or third-party
                                            rights
                                        </span>
                                    </li>
                                    <li className="flex items-start">
                                        ...
                                        <span>
                                            ...
                                            disrupt our Services or servers
                                        </span>
                                    </li>
                                    <li className="flex items-start">
                                        <div className="w-2 h-2 bg-purple-400 rounded-full mt-2 mr-3 shrink-0"></div>
                                    ...
                                    <li className="flex items-start">
                                        ...
                                        <span>
                                            ...
                                            develop or distribute malicious
                                            software, spam, or content that
                            ...
                            <div className="space-y-6">
                                <div className="bg-white/5 rounded-xl p-6 border border-white/5">
                                    ...
                                    <p className="text-gray-300 leading-relaxed mb-3">
                                        Payment terms, including fees, payment
                                        schedules, and methods, will be
                                        specified in your project agreement or
                                        SOW. Unless otherwise agreed:
                                    </p>
                                    <ul className="space-y-2 text-gray-300 ml-4">
                                        <li className="flex items-start">
                                            <div className="w-2 h-2 bg-violet-400 rounded-full mt-2 mr-3 shrink-0"></div>
                                            <span>
                                                Fees are due according to the
                                                payment schedule in your
                                                agreement
                                            </span>
                                        </li>
                                        <li className="flex items-start">
                                ...
                                <div className="bg-white/5 rounded-xl p-6 border border-white/5">
                                    ...
                                    <p className="text-gray-300 leading-relaxed">
                                        All sales are final. Orvex Studios does
                                        not offer refunds for completed work,
                                        partially completed projects, or
                                        services rendered, except as may be
                                        explicitly agreed upon in writing in
                                        your project agreement. This includes
                                        but is not limited to: completed
                                        development work, delivered code, design
                                        assets, consulting sessions, or any
                        ...
                        <section className="group">
                            ...
                            <div className="space-y-6">
                                <div className="bg-white/5 rounded-xl p-6 border border-white/5">
                                    ...
                                    <p className="text-gray-300 leading-relaxed">
                                        Upon full payment, ownership of
                                        custom-developed code, designs, and
                                        deliverables created specifically for
                                        you will transfer to you as specified in
                                        your project agreement. You will receive
                                        a license or assignment of rights as
                                        agreed upon.
                                    </p>
                                </div>
                                <div className="bg-white/5 rounded-xl p-6 border border-white/5">
                                    <h3 className="font-semibold text-white mb-3">
                                        5.2 Orvex Studios&apos; Intellectual
                                        Property
                                    </h3>
                                    <p className="text-gray-300 leading-relaxed mb-3">
                                    ...
                                    <ul className="space-y-2 text-gray-300 ml-4">
                                        ...
                                        <li className="flex items-start">
                                            <div className="w-2 h-2 bg-red-400 rounded-full mt-2 mr-3 shrink-0"></div>
                                            <span>
                                                Pre-existing code, templates, or
                                                assets not created specifically
                                                for your project
                                            </span>
                                        </li>
                                        <li className="flex items-start">
                                ...
                                <div className="bg-white/5 rounded-xl p-6 border border-white/5">
                                    ...
                                    <p className="text-gray-300 leading-relaxed">
                                        ...
                                        to use the Services and deliverables
                                        solely for your internal business
                                        purposes as specified in your agreement.
                                        You may not resell, redistribute, or
                                        reverse engineer our Services without
                                        written permission.
                                    </p>
                                </div>
                            </div>
                        ...
                        <section className="group">
                            ...
                            <div className="bg-white/5 rounded-xl p-6 border border-white/5">
                                <p className="text-gray-300 leading-relaxed mb-4">
                                    Deliverables will be provided according to
                                    the timeline and specifications in your
                                    project agreement. You will have a
                                    reasonable period (typically 14 days) to
                                    review and accept deliverables. If you do
                                    not provide feedback or request changes
                                    within this period, deliverables will be
                                    deemed accepted. Requested changes beyond
                                    the original scope may incur additional
                                    fees.
                                </p>
                            </div>
                        </section>
                            ...
                            <div className="space-y-6">
                                <div className="bg-white/5 rounded-xl p-6 border border-white/5">
                                    ...
                                    <p className="text-gray-300 leading-relaxed">
                                        ...
                                        industry standards. We will use
                                        reasonable efforts to ensure
                                        deliverables are free from material
                                        defects for a period of 30 days after
                                        delivery.
                                    </p>
                                </div>
                                <div className="bg-white/5 rounded-xl p-6 border border-white/5">
                                    ...
                                    <p className="text-gray-300 leading-relaxed mb-3">
                                        EXCEPT AS EXPRESSLY SET FORTH ABOVE, OUR
                                    ...
                                    <ul className="space-y-2 text-gray-300 ml-4">
                                        ...
                                        <li className="flex items-start">
                                            <div className="w-2 h-2 bg-yellow-400 rounded-full mt-2 mr-3 shrink-0"></div>
                                            <span>
                                                Warranties that Services will be
                                        ...
                                        <li className="flex items-start">
                                            <div className="w-2 h-2 bg-yellow-400 rounded-full mt-2 mr-3 shrink-0"></div>
                                            <span>
                                                Warranties regarding third-party
                                                software, APIs, or services
                        ...
                        <section className="group">
                            ...
                            <div className="bg-white/5 rounded-xl p-6 border border-white/5">
                                <p className="text-gray-300 leading-relaxed mb-4">
                                    ...
                                    Orvex Studios SHALL NOT BE LIABLE FOR:
                                </p>
                                <ul className="space-y-3 text-gray-300 mb-4">
                                    ...
                                    <li className="flex items-start">
                                        <div className="w-2 h-2 bg-cyan-400 rounded-full mt-2 mr-3 shrink-0"></div>
                                        <span>
                                            Issues arising from third-party
                                            services, APIs, or software
                                        </span>
                                    </li>
                                </ul>
                                <p className="text-gray-300 leading-relaxed">
                                    Our total liability for any claims arising
                                    from or related to these Terms or the
                                    Services shall not exceed the total amount
                                    paid by you to Orvex Studios in the 12
                                    months preceding the claim. Some
                                    jurisdictions do not allow the exclusion of
                                    certain warranties or limitation of
                            ...
                            <div className="space-y-6">
                                <div className="bg-white/5 rounded-xl p-6 border border-white/5">
                                    ...
                                    <p className="text-gray-300 leading-relaxed">
                                        ...
                                        written notice. You remain responsible
                                        for all fees incurred up to the
                                        termination date and any early
                                        termination fees specified in your
                                        agreement.
                                    </p>
                                </div>
                                <div className="bg-white/5 rounded-xl p-6 border border-white/5">
                                    ...
                                    <ul className="space-y-2 text-gray-300 ml-4">
                                        <li className="flex items-start">
                                            ...
                                            <span>
                                                You breach these Terms or your
                                                project agreement
                                            </span>
                                        </li>
                                        <li className="flex items-start">
                                            <div className="w-2 h-2 bg-indigo-400 rounded-full mt-2 mr-3 shrink-0"></div>
                                            <span>
                                                You fail to make payments when
                                                due
                                            </span>
                                        </li>
                                        <li className="flex items-start">
                                ...
                                <div className="bg-white/5 rounded-xl p-6 border border-white/5">
                                    ...
                                    <p className="text-gray-300 leading-relaxed">
                                        ...
                                        Services ceases immediately. We may
                                        delete your data after a reasonable
                                        retention period. Sections of these
                                        Terms that by their nature should
                            ...
                            <div className="space-y-6">
                                <div className="bg-white/5 rounded-xl p-6 border border-white/5">
                                    ...
                                    <p className="text-gray-300 leading-relaxed">
                                        ...
                                        support@orvex.cc to attempt to resolve
                                        any dispute informally. We will work in
                                        good faith to resolve disputes within 30
                                ...
                                <div className="bg-white/5 rounded-xl p-6 border border-white/5">
                                    ...
                                    <p className="text-gray-300 leading-relaxed">
                                        ...
                                        in court to prevent irreparable harm or
                        ...
                        <section className="group">
                            ...
                            <div className="bg-white/5 rounded-xl p-6 border border-white/5">
                                <p className="text-gray-300 leading-relaxed">
                                    ...
                                    shared during the course of providing
                                    Services. This includes business plans,
                                    technical specifications, source code, and
                                    other sensitive information. Confidentiality
                                    obligations survive termination of Services
                                    and will be detailed in your project
                                    agreement or a separate Non-Disclosure
                                    Agreement (NDA).
                                </p>
                            </div>
                        </section>
                        ...
                        <section className="group">
                            ...
                            <div className="bg-white/5 rounded-xl p-6 border border-white/5">
                                <p className="text-gray-300 leading-relaxed">
                                    ...
                                    our Privacy Policy and applicable data
                                    protection laws, including GDPR and CCPA.
                                    When we process data on your behalf as part
                                    of Services, we act as a data processor and
                                    will enter into appropriate Data Processing
                        ...
                        <section className="group">
                            ...
                            <div className="bg-white/5 rounded-xl p-6 border border-white/5">
                                <p className="text-gray-300 leading-relaxed">
                                    ...
                                    notified via email or through our Services.
                                    Your continued use of Services after changes
                                    become effective constitutes acceptance of
                                    the modified Terms. If you do not agree to
                                    the changes, you must discontinue use of
                                    Services.
                                </p>
                            </div>
                        </section>
                        ...
                        <section className="group">
                            ...
                            <div className="bg-white/5 rounded-xl p-6 border border-white/5">
                                <p className="text-gray-300 leading-relaxed">
                                    These Terms, together with your project
                                    agreement, SOW, Privacy Policy, and any
                                    other referenced documents, constitute the
                                    entire agreement between you and Orvex
                                    Studios regarding the Services. They
                                    supersede all prior agreements,
                                    negotiations, and communications, whether
                                    oral or written.
                                </p>
                            </div>
                        </section>
