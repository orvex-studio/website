                ...
                <div className="bg-linear-to-br from-zinc-950/80 to-zinc-900/80 backdrop-blur-xl border border-white/10 rounded-3xl p-8 sm:p-12 shadow-2xl">
                    <div className="space-y-12">
                        <section className="group">
                            <div className="bg-white/5 rounded-xl p-6 border border-white/5">
                                <p className="text-gray-300 leading-relaxed text-lg">
                                    ...
                                    when you use our services, including our
                                    products, platforms, and ventures. This
                                    includes web applications, mobile apps,
                                    enterprise systems, and other technology
                                    solutions we develop. By using our services,
                        ...
                        <section className="group">
                            ...
                            <div className="space-y-4 text-gray-300 leading-relaxed">
                                <div className="bg-white/5 rounded-xl p-6 border border-white/5">
                                    ...
                                    <p className="mb-3">
                                        When you engage with Orvex Studios for
                                        development services, we may collect:
                                    </p>
                                ...
                                <div className="bg-white/5 rounded-xl p-6 border border-white/5">
                                    ...
                                    <p className="mb-3">
                                        ...
                                        services, we automatically collect:
                                    </p>
                                    <ul className="space-y-2 ml-4">
                                        <li className="flex items-start">
                                            <div className="w-2 h-2 bg-blue-400 rounded-full mt-2 mr-3 shrink-0"></div>
                                ...
                                <div className="bg-white/5 rounded-xl p-6 border border-white/5">
                                    ...
                                    <p>
                                        As an umbrella company, we may process
                                        data on behalf of our ventures,
                                        products, or partners as part of our
                                        operations. This data is handled
                                        according to our Data Processing
                                        Agreements and remains the property of
                                        the respective entities. We act as a
                                        data processor in these instances.
                                    </p>
                                </div>
                            </div>
                        </section>
                        ...
                        <section className="group">
                            ...
                            <div className="bg-white/5 rounded-xl p-6 border border-white/5">
                                <p className="text-gray-300 leading-relaxed mb-4">
                                    ...
                                    (GDPR), we process your personal data based
                                    on:
                                </p>
                                    ...
                                    <li className="flex items-start">
                                        ...
                                        <div>
                                            <strong className="text-white">
                                                Contract Performance (Article
                                                6(1)(b)):
                                            </strong>{" "}
                                            To fulfill our contractual
                                            obligations when providing
                                            development services, consulting, or
                                            project delivery.
                                        </div>
                                    </li>
                                    <li className="flex items-start">
                                        ...
                                        <div>
                                            ...
                                            newsletters, or non-essential data
                                            processing.
                                        </div>
                                    </li>
                                    <li className="flex items-start">
                                        ...
                                        <div>
                                            ...
                                            For business operations, fraud
                                            prevention, service improvement, and
                                            security measures.
                                        </div>
                                    </li>
                                    <li className="flex items-start">
                                        ...
                                        <div>
                                            <strong className="text-white">
                                                Legal Obligations (Article
                                                6(1)(c)):
                                            </strong>{" "}
                                            To comply with applicable laws, tax
                            ...
                            <div className="bg-white/5 rounded-xl p-6 border border-white/5">
                                <ul className="space-y-3 text-gray-300">
                                    <li className="flex items-start">
                                        ...
                                        <span>
                                            Deliver and manage development
                                            projects, software solutions, and
                                            consulting services
                                        </span>
                                    </li>
                                    <li className="flex items-start">
                                    ...
                                    <li className="flex items-start">
                                        <div className="w-2 h-2 bg-purple-400 rounded-full mt-2 mr-3 shrink-0"></div>
                                        <span>
                                            Communicate about projects, updates,
                                    ...
                                    <li className="flex items-start">
                                        <div className="w-2 h-2 bg-purple-400 rounded-full mt-2 mr-3 shrink-0"></div>
                                        <span>
                                            Improve our services, website, and
                                            user experience
                                        </span>
                                    </li>
                                    <li className="flex items-start">
                                    ...
                                    <li className="flex items-start">
                                        <div className="w-2 h-2 bg-purple-400 rounded-full mt-2 mr-3 shrink-0"></div>
                                        <span>
                                            Detect and prevent fraud, abuse, or
                                            security threats
                                        </span>
                                    </li>
                                    <li className="flex items-start">
                                ...
                                <ul className="space-y-4 text-gray-300">
                                    <li className="flex items-start">
                                        ...
                                        <div>
                                            ...
                                            analytics, email delivery, and other
                                            essential services. These providers
                                    ...
                                    <li className="flex items-start">
                                        ...
                                        <div>
                                            ...
                                            or government regulation, or to
                                    ...
                                    <li className="flex items-start">
                                        ...
                                        <div>
                                            ...
                                            acquisition, sale of assets, or
                                            bankruptcy, your information may be
                            ...
                            <div className="bg-white/5 rounded-xl p-6 border border-white/5">
                                ...
                                <ul className="space-y-3 text-gray-300">
                                    <li className="flex items-start">
                                        ...
                                        <span>
                                            Encryption in transit (TLS/SSL) and
                                            at rest
                                        </span>
                                    </li>
                                    <li className="flex items-start">
                                ...
                                <p className="text-gray-300 leading-relaxed mt-4">
                                    Despite our efforts, no method of
                                    transmission over the internet is 100%
                                    secure. We cannot guarantee absolute
                                    security but are committed to protecting
                                    your data.
                                </p>
                            </div>
                        </section>
                        ...
                        <section className="group">
                            ...
                            <div className="bg-white/5 rounded-xl p-6 border border-white/5">
                                ...
                                <ul className="space-y-3 text-gray-300 mb-6">
                                    ...
                                    <li className="flex items-start">
                                        ...
                                        <div>
                                            ...
                                            Request limitation of how we process
                                            your data.
                                        </div>
                                    </li>
                                    <li className="flex items-start">
                                    ...
                                    <li className="flex items-start">
                                        ...
                                        <div>
                                            ...
                                            legitimate interests or for direct
                                            marketing.
                                        </div>
                                    </li>
                                    <li className="flex items-start">
                                ...
                                <p className="text-gray-300 leading-relaxed">
                                    ...
                                    privacy@orvex.cc. We will respond within 30
                            ...
                            <div className="bg-white/5 rounded-xl p-6 border border-white/5">
                                ...
                                <ul className="space-y-3 text-gray-300 mb-6">
                                    <li className="flex items-start">
                                        ...
                                        <div>
                                            ...
                                            business purposes, and third parties
                                ...
                                <ul className="space-y-2 text-gray-300 ml-4 mb-4">
                                    ...
                                    <li className="flex items-start">
                                        <div className="w-2 h-2 bg-emerald-400 rounded-full mt-2 mr-3 shrink-0"></div>
                                        <span>
                                            Commercial information (purchase
                                ...
                                <p className="text-gray-300 leading-relaxed">
                                    ...
                                    privacy@orvex.cc or call us. We will verify
                        ...
                        <section className="group">
                            ...
                            <div className="bg-white/5 rounded-xl p-6 border border-white/5">
                                <p className="text-gray-300 leading-relaxed">
                                    ...
                                    safeguards are in place, including Standard
                                    Contractual Clauses (SCCs) approved by the
                                    European Commission for GDPR compliance, and
                                    we only transfer data to countries with
                                    adequate data protection laws or appropriate
                                    safeguards.
                                </p>
                            </div>
                        </section>
                        ...
                        <section className="group">
                            ...
                            <div className="bg-white/5 rounded-xl p-6 border border-white/5">
                                <p className="text-gray-300 leading-relaxed">
                                    ...
                                    collected information from a child, we will
                                    delete it immediately. If you believe we
                        ...
                        <section className="group">
                            ...
                            <div className="bg-white/5 rounded-xl p-6 border border-white/5">
                                <p className="text-gray-300 leading-relaxed mb-4">
                                    We use cookies and similar tracking Services
                                ...
                                <ul className="space-y-3 text-gray-300">
                                    <li className="flex items-start">
                                        ...
                                        <div>
                                            ...
                                            Required for core functionality and
                                            cannot be disabled.
                                        </div>
                                    </li>
                                    <li className="flex items-start">
                                ...
                                <p className="text-gray-300 leading-relaxed mt-4">
                                    ...
                                    settings. Note that disabling cookies may
                        ...
                        <section className="group">
                            <h2 className="text-xl font-bold text-white mb-6 flex items-center">
                                ...
                                12. Data Protection Officer & Supervisory
                                Authority
                            </h2>
                            <div className="bg-white/5 rounded-xl p-6 border border-white/5">
                                <p className="text-gray-300 leading-relaxed mb-4">
                                ...
                                <p className="text-gray-300 leading-relaxed">
                                    If you are located in the EEA, you have the
                                    right to lodge a complaint with your local
                                    supervisory authority if you believe we have
                                    violated GDPR. A list of supervisory
                        ...
                        <section className="group">
                            ...
                            <div className="bg-white/5 rounded-xl p-6 border border-white/5">
                                <p className="text-gray-300 leading-relaxed">
                                    ...
                                    updated&quot; date. For significant changes,
                                    we may also notify you via email or through
                                    our services. Your continued use of our
                                    services after changes become effective
