...
const companies: Company[] = [
    {
        name: "DriftLabs",
        description: "Developer utilities SaaS platform.",
        category: "Developer Tools",
        url: "https://driftlabs.dev",
        image: "/img/projects/driftlabs.png",
    },
    {
        name: "Fluxo",
        description: "Open-source billing panel for hosting companies.",
        category: "Hosting",
        url: "https://getfluxo.io",
        image: "/img/projects/fluxo.png",
    },
];
                            ...
                            return (
                                ...
                                >
                                    <div className="flex items-start justify-between mb-4">
                                        {company.image ? (
                                            <div className="w-12 h-12 rounded-lg overflow-hidden bg-white/5 flex items-center justify-center group-hover:scale-110 transition-transform">
                                                <Image
                                                    src={company.image}
